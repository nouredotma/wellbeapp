...
const Institus = () => {
  ...
  const word = "institut de beauté"

  // Add these state variables and functions after the existing state declarations
  ...
  const handleInputChange = (e) => {
    ...
    // Find the matching establishment type
      ...
      <section className="relative bg-gradient-to-r from-slate-900 to-slate-800 py-16 md:py-24">
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-2xl md:text-2xl lg:text-3xl font-bold mb-6 text-white">
              Réserver en ligne un RDV avec un{" "}
              <span className="text-white opacity-70 inline-block">{displayedWord}</span>
            </h1>
            <p className="text-slate-300 mb-8 text-lg">
              Trouvez votre institut à <span className="text-white opacity-70 inline-block">{displayedWord1}</span>
            </p>

            <form
              onSubmit={(e) => {
                e.preventDefault()
                navigate(`/post-filter?establishmentId=${selectedEstablishmentId}&location=${locationQuery}`)
              }}
          ...
          <div className="w-full md:w-[90%] lg:w-[90%] mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {cities.slice(0, showAllCities ? cities.length : 3).map((city, index) => (
                // Update the city links in the Cities Section to navigate to post-filter
                // Find each <a> tag in the cities map and update the href to:
                ...
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault()
                    navigate(`/post-filter?location=${city.name}`)
                  }}
                ...
                >
                  <div className="relative h-56 overflow-hidden">
                    <img
                      ...
                      alt={`Institut de beauté à ${city.name}`}
                  ...
                  <div className="p-5">
                    ...
                    <h3 className="text-xl font-bold text-slate-900 group-hover:text-slate-700 transition-colors">
                      Instituts de beauté à {city.name}
                    </h3>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">
              ...
              rendez-vous dans un institut de beauté.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-slate-50 p-6 rounded-xl text-center">
              ...
              <p className="text-slate-600">Tous nos instituts sont des établissements qualifiés et vérifiés</p>
            </div>
            ...
            <div className="bg-slate-50 p-6 rounded-xl text-center">
              ...
              <p className="text-slate-600">Consultez les avis des clients pour choisir le meilleur institut</p>
            </div>
          </div>
        </div>
      </section>
