...
import { MapPin, Scissors, Search, User } from "lucide-react"
  ...
  return (
    <Layout>
      ...
      <section className="relative bg-gradient-to-r from-slate-900 to-slate-800 py-16 md:py-24">
        <div className="absolute inset-0 opacity-20 bg-[url('https://images.unsplash.com/photo-1585747860715-2ba37e788b70?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2074&q=80')] bg-cover bg-center"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-slate-300 mb-8 text-lg">
              Trouvez votre coiffeur à <span className="text-white opacity-70 inline-block">{displayedWord1}</span>
            </p>
            <div className="w-full max-w-3xl p-0 md:p-2 lg:rounded-full rounded-3xl md:bg-white sm:bg-transparent transform transition-all duration-1000 hover:shadow-[0_20px_50px_rgba(0,35,102,0.2)]">
          ...
          <div className="w-full md:w-[90%] lg:w-[90%] mx-auto">
            <div className="mb-10">
              <h2 className="text-2xl md:text-3xl font-bold text-slate-900 flex items-center">
                <div className="mr-3 bg-slate-100 p-1.5 rounded-full">
                  <Scissors className="h-5 w-5 text-slate-800 transform rotate-45" />
                </div>
                Coiffeurs
              </h2>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-slate-50 p-6 rounded-xl text-center">
              ...
              <p className="text-slate-600">Tous nos coiffeurs sont des professionnels qualifiés et vérifiés</p>
            </div>
            ...
            <div className="bg-slate-50 p-6 rounded-xl text-center">
              ...
              <p className="text-slate-600">Consultez les avis des clients pour choisir le meilleur coiffeur</p>
            </div>
          </div>
        </div>
      </section>
